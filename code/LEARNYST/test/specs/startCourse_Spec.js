...
{	
	...
	beforeAll(function(){
		...
		startCoursePage.startcourse.selectProfile.waitForExist(6000);
        startCoursePage.startcourse.selectProfile.click();
        startCoursePage.startcourse.settings.waitForExist(5000);
        startCoursePage.startcourse.settings.click();
        startCoursePage.startcourse.mobileNumber.waitForExist(5000);
        startCoursePage.startcourse.mobileNumber.setValue(contact);
        startCoursePage.startcourse.saveSettings.waitForExist(5000);
        startCoursePage.startcourse.saveSettings.click();
